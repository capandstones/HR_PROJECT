...
public interface NoticeMapper {
	...
	// 카테고리 식별
	@Select("select board_info_name " + "from HRPROJECT.NoticeBoardInfoBean " + "where board_info_idx = #{board_info_idx}")
...
//	List<NoticeContentBean> getContentList();
	...
	@Select("select count(*) HRPROJECT.from notice_content where content_board_idx = #{content_board_idx}")
