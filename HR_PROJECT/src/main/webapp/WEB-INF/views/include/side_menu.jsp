  ...
  <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
    <div class="sb-sidenav-menu">
      <div class="sb-sidenav-footer" style="left-padding: 30px">
        <img
          src="${root }image/Black-_-White-Minimal-Business-Logo.svg"
      ...
      <div class="nav">
        ...
        <div
          ...
          style="background-color: #415971"
        >
          <nav class="sb-sidenav-menu-nested nav">
            <a
              class="nav-link"
              href="${root}notice/all_read/noticeAll?board_info_idx=1"
              >전체 공지사항</a
            >
            <a class="nav-link" href="${root}notice/sub_read/noticeSubDetail"
              >부서 공지사항</a
            >
          </nav>
        </div>
...
<script>
  ...
  function showAttendanceTime(type) {
    ...
    attendanceTimeDiv.innerHTML +=
      type + ' 시간: ' + formattedHours + ':' + formattedMinutes + '<br />';
  }
