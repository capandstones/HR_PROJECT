					...
					<tbody>
						<c:forEach items="${contentList}" var='obj'>
							<tr>
								...
								<td>
									<a href="${root}notice/sub/read?board_info_idx=${board_info_idx}&content_idx=${obj.content_idx}&page=${page}">${obj.content_subject}</a>
								</td>
					...
					<ul class="pagination justify-content-center">
						...
						<c:forEach var='idx' begin="${pageBean.min }" end="${pageBean.max }">
							<c:choose>
								...
								<c:otherwise>
									<li class="page-item"><a href="${root }notice/sub/noticeSubDetail?board_info_idx=${board_info_idx}&page=${idx}" class="page-link">${idx }</a></li>
								</c:otherwise>
							</c:choose>
						</c:forEach>
