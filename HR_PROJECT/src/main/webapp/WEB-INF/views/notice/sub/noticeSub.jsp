                ...
                <div class="col-lg-6" style="margin-top: 20px">
                  <div class="card shadow">
                    <div class="card-body">
                        ...
                        <tbody>
                          <c:forEach var="obj" items="${sub_list }">
                            <tr>
                              ...
                              <th>
                                <a
                                  href="${root }notice/sub/read?board_info_idx=${noticeMenuList[idx.index].board_info_idx}&content_idx=${obj.content_idx}&page1"
                      ...
                      <a
                        href="${root }notice/sub/noticeSubDetail?board_info_idx=${noticeMenuList[idx.index].board_info_idx}"
