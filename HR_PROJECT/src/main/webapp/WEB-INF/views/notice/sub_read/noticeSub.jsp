                ...
                <div class="col-lg-6" style="margin-top: 20px">
                  <div class="card shadow">
                    <div class="card-body">
                      ...
                      <table class="table table-hover" id="board_list">
                        <thead>
                          <tr>
                            ...
                            <th>제목</th>
                            <th class="text-center w-25 d-none d-xl-table-cell">
                              작성날짜
                            </th>
                          </tr>
                        </thead>
                        <tbody>
                          <c:forEach var="obj" items="${sub_list }">
                            <tr>
                              ...
                              <th>
                                <a
                                  href="${root }notice/sub_read/read?board_info_idx=${noticeMenuList[idx.index].board_info_idx}&content_idx=${obj.content_idx}&page1"
                      ...
                      <a
                        href="${root }notice/sub_read/noticeSubDetail?board_info_idx=${noticeMenuList[idx.index].board_info_idx}"
