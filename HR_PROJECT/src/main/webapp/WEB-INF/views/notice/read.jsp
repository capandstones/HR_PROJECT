								...
								<div class="card-body">
									...
									<div class="form-group">
										<div class="text-right">
											<a href="${root }notice/noticeAll?board_info_idx=${board_info_idx}&page=${page}" class="btn btn-primary">목록보기</a>
										
												<a href="${root }notice/modify?board_info_idx=${board_info_idx}&content_idx=${content_idx}&page=${page}" class="btn btn-info">수정하기</a>
												<a href="${root }notice/delete?board_info_idx=${board_info_idx}&content_idx=${content_idx}&page=${page}" class="btn btn-danger">삭제하기</a>
