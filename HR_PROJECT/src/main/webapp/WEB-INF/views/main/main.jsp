...
<style>
.employee-main-li { display: flex; height: 160px; width: 400px; border: 1px solid lightgray; border:none;}
.employee-list-profile { height: 140px; width: 120px; margin-left:10px; border-radius: 3%;}
                     ...
                     <div class="card text-black mb-4" style="position: relative; height: 260px; color: #fff;">
                        ...
                        <div class="card-body">
                           ...
                           <div style="color: black; font-size: 17pt; margin-top: 25px;">
                              ...
                              <p>  근무했습니다</p>
                              <p style="font-size: 10pt; color: grey;">잔여 기본 근로시간: 100시간 26분 (잔여일수 12일)</p>
                           </div>
                     ...
                     <div class="card text-black mb-4" style="height: 280px; color: #fff;">
                        ...
                        <div class="card-body">
                           <div class="vacation-info-container">
                              ...
                              <div>
                                 <span style="font-size: 19px;">올해 사용 가능한 휴가는 <strong>7</strong>일 입니다.</span>
                              </div>
                           </div>
